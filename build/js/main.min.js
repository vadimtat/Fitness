...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _video__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./video */ "./js/video.js");
...
/* harmony import */ var _valid__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./valid */ "./js/valid.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_video__WEBPACK_IMPORTED_MODULE_0__["initVideo"])();
  Object(_swiper__WEBPACK_IMPORTED_MODULE_1__["initSwiper"])();
  Object(_tabs__WEBPACK_IMPORTED_MODULE_2__["initTabs"])();
  Object(_valid__WEBPACK_IMPORTED_MODULE_3__["initForms"])();
  Object(_mask__WEBPACK_IMPORTED_MODULE_4__["initMaskPhone"])();
...
function initSwiper() {
  var trainers = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.trainer__swiper', {
    // Optional parameters
    direction: 'horizontal',
    loop: true,
  ...
  var comments = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.comment__swiper', {
    // Optional parameters
    direction: 'horizontal',
    loop: true,
    scrollbar: {
...
function setupVideo(video) {
  ...
  var YOUTUBE_ID = link.href.slice(32);
  video.addEventListener('click', function () {
    var iframe = createIframe(YOUTUBE_ID);
    link.remove();
    button.remove();
    overlay.remove();
...
function createIframe(ytId) {
  ...
  iframe.setAttribute('src', "https://www.youtube.com/embed/".concat(ytId, "?controls=0?rel=0&showinfo=0&autoplay=1"));
